...
from path_finder import input_file_path_finder, temp_support_file_path_finder, output_file_path_generator
...
def main():
	...
	pdf_to_exel_converter_main(input_path, temp_support_path)
